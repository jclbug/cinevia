    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white py-16">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center mb-12">
          ...
          <img src="favicon.png" alt="cinevia logo" className="w-[80px]" />
          <h1 className="text-5xl font-bold">About Cinevia</h1>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <section className="mb-12">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              At Cinevia, our mission is to connect movie enthusiasts with the
          ...
          <section className="mb-12">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-4">
              Cinevia was founded in 2023 by a group of film enthusiasts who
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              We're constantly working to improve Cinevia and add new features
          ...
          <section>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Cinevia uses data from The Movie Database (TMDB) and other trusted
              sources to provide accurate and up-to-date information. We're
              grateful to these organizations for making their data available
              and helping us create a comprehensive resource for our users.
            </p>
          </section>
        </div>
      </div>
